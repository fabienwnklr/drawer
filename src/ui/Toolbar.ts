        ...
        try {
          if (this.$toolbar && !this.$lineThickness) {
            ...
            <div class="drawer-range">
              <input title="${'Thickness'}" id="${this.drawer.$canvas.id}-line-tickness" type="range" class="" min="1" value="${
                this.drawer.options.lineThickness
              }" max="30" />
        ...
        try {
          if (this.$toolbar && !this.$colorPicker) {
            ...
            <div class="container-colorpicker">
              <input class="btn" title="${'Color'}" id="colopicker-${this.drawer.options.id}" class="" type="text" value="${
                this.drawer.options.color
              }" data-coloris/>
            </div>
            `;
