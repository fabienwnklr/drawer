...
export default function CustomToolbar() {
  useEffect(() => {
    ...
    window.customToolbar = new Drawer($el, { defaultToolbar: false });
    window.customToolbar.toolbar.addToolbar();
    window.customToolbar.toolbar.addBrushBtn();
    window.customToolbar.toolbar.addEraserBtn();
  }, []);
